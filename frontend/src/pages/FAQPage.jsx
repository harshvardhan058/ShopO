      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 1 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@shopoecommerce.com with your order number and a
          ...
          {activeTab === 3 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@shopoecommerce.com, or by calling us at 1800123145
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept visa,Mastercard,Rupay,paypal payment method also we
                have cash on delivery system.
              </p>
            </div>
          )}
        </div>
